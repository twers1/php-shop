      ...
      <h1 class="title">products added in cart</h1>
        <div class="box-container">
            ...
            <div class="box">
              ...
              <div class="icon">
                        ...
                        <a href="cart.php?pid=<?php echo $fetch_cart['id']; ?>" class="bx bx-x" onclick="return confirm('delete this from cart?');"></a>
                    ...
                    <div class="total-amt">
                        Total Amount : <span><?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?></span>
                    </div>
        ...
        <div class="wishlist_total">
            ...
            <a href="checkout.php" class="btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>"
             onclick="return confirm('delete all from cart?');">proceed to checkout</a>
        </div>
  </section>
    <div class="line3"></div>
